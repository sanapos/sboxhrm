...
public sealed class RequireAnyModulePermissionFilter(
    string[] modules,
    ...
    IModulePermissionService permissionService) : IAsyncAuthorizationFilter
{
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        var moduleList = string.Join(" hoặc ", modules);
        ...
        context.Result = new ObjectResult(
            AppResponse<object>.Fail($"Tài khoản không có quyền {actionLabel} module {moduleList}."))
        {
