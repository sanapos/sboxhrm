...
public class PermissionConfiguration : IEntityTypeConfiguration<Permission>
{
    public void Configure(EntityTypeBuilder<Permission> builder)
    {
        ...
        builder.HasData(
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111085"), Module = "BusinessTripExpense", ModuleDisplayName = "Công tác phí", Description = "Ứng công tác, hoạch toán chi phí đi công tác", DisplayOrder = 17 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111086"), Module = "BusinessTripReport", ModuleDisplayName = "Báo cáo công tác phí", Description = "Tổng hợp ứng công tác, hoạch toán chi phí", DisplayOrder = 54 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111084"), Module = "PosSalesReport", ModuleDisplayName = "Báo cáo POS (tổng hợp)", Description = "Hub báo cáo POS / màn gộp cũ", DisplayOrder = 62 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111108"), Module = "PosReportRevenue", ModuleDisplayName = "Doanh thu", Description = "Báo cáo doanh thu bán hàng", DisplayOrder = 73 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111109"), Module = "PosReportSoldGoods", ModuleDisplayName = "Hàng hóa bán ra", Description = "Top hàng theo doanh thu", DisplayOrder = 74 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111110"), Module = "PosReportStock", ModuleDisplayName = "Tồn kho", Description = "Báo cáo tồn kho hiện tại", DisplayOrder = 75 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), Module = "PosReportPurchases", ModuleDisplayName = "Báo cáo nhập hàng", Description = "Phiếu nhập / trả NCC", DisplayOrder = 76 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111112"), Module = "PosReportPayment", ModuleDisplayName = "Phương thức thanh toán", Description = "Cơ cấu đã thu theo PTTT", DisplayOrder = 77 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111113"), Module = "PosReportDebt", ModuleDisplayName = "Công nợ", Description = "Công nợ khách hàng và nhà cung cấp", DisplayOrder = 78 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111114"), Module = "PosReportExpiry", ModuleDisplayName = "Hàng sắp hết hạn", Description = "Lô / hạn sử dụng", DisplayOrder = 79 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111115"), Module = "PosReportProfit", ModuleDisplayName = "Lợi nhuận", Description = "Lợi nhuận gộp, giá vốn, biên LN", DisplayOrder = 80 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111116"), Module = "PosReportExpense", ModuleDisplayName = "Chi phí", Description = "Phiếu chi theo nhóm", DisplayOrder = 81 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111117"), Module = "PosReportEndOfDay", ModuleDisplayName = "Tổng kết cuối ngày", Description = "Báo cáo cuối ngày theo nhân viên", DisplayOrder = 82 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111118"), Module = "PosReportStaffRevenue", ModuleDisplayName = "Doanh thu theo nhân viên", Description = "Doanh thu theo người bán", DisplayOrder = 83 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111124"), Module = "PosReportStaffCommission", ModuleDisplayName = "Hoa hồng nhân viên", Description = "Hoa hồng theo hàng/DV và combo", DisplayOrder = 88 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111119"), Module = "PosReportCashbook", ModuleDisplayName = "Sổ quỹ", Description = "Thu / chi / chênh lệch quỹ", DisplayOrder = 84 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111120"), Module = "PosReportPnl", ModuleDisplayName = "Kết quả kinh doanh", Description = "P&L: DT, giá vốn, chi phí, LN ròng", DisplayOrder = 85 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111121"), Module = "PosReportVoucher", ModuleDisplayName = "Báo cáo voucher", Description = "Voucher đã dùng trên hóa đơn", DisplayOrder = 86 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111107"), Module = "PosEInvoice", ModuleDisplayName = "Hóa đơn điện tử POS", Description = "Viettel SInvoice, Easy Invoice, MISA — cấu hình, xuất, báo cáo", DisplayOrder = 67 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111103"), Module = "PosKds", ModuleDisplayName = "Màn hình bếp (KDS)", Description = "Phiếu chế biến, bump món, đọc món, in khi xong", DisplayOrder = 68 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111104"), Module = "PosQrOrder", ModuleDisplayName = "QR order bàn", Description = "In/sao QR gọi món tại bàn, bật/tắt QR order", DisplayOrder = 69 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111125"), Module = "PosQuotes", ModuleDisplayName = "Báo giá", Description = "Báo giá thương mại độc lập — hạn, mẫu, trạng thái; không trừ kho / không bán hàng", DisplayOrder = 89 }
        );
    }
}
