...
public class PermissionConfiguration : IEntityTypeConfiguration<Permission>
{
    public void Configure(EntityTypeBuilder<Permission> builder)
    {
        ...
        builder.HasData(
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111050"), Module = "BonusPenalty", ModuleDisplayName = "Thưởng / Phạt", Description = "Quản lý thưởng phạt", DisplayOrder = 16 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111054"), Module = "MobileDeviceRegistration", ModuleDisplayName = "Đăng ký CC Mobile", Description = "Quản lý đăng ký thiết bị chấm công mobile", DisplayOrder = 46 },
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111055"), Module = "MobileAttendanceApproval", ModuleDisplayName = "Duyệt CC Mobile", Description = "Duyệt yêu cầu chấm công mobile", DisplayOrder = 47 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111057"), Module = "HrReport", ModuleDisplayName = "Báo cáo nhân sự", Description = "Thống kê nhân sự, phòng ban", DisplayOrder = 23 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111059"), Module = "PayrollReport", ModuleDisplayName = "Báo cáo lương", Description = "Chi phí lương, phân bổ", DisplayOrder = 25 },
            ...
            new Permission { Id = Guid.Parse("11111111-1111-1111-1111-111111111062"), Module = "MobileAttendance", ModuleDisplayName = "Chấm công mobile", Description = "Face ID, GPS, vùng chấm công", DisplayOrder = 28 },
