    ...
    public async Task<AppResponse<ShiftTemplateDto>> Handle(CreateShiftTemplateCommand request, CancellationToken cancellationToken)
    {
        try
        {
            var shiftTemplate = new ShiftTemplate
            {
                ...
                LunchBreakStartTime = request.LunchBreakStartTime,
                LunchBreakEndTime = request.LunchBreakEndTime,
                ...
                EarlyOvertimeMinutesThreshold = request.EarlyOvertimeMinutesThreshold,
            ...
            var templateDto = new ShiftTemplateDto
            {
                ...
                LunchBreakStartTime = templateWithManager.LunchBreakStartTime,
                LunchBreakEndTime = templateWithManager.LunchBreakEndTime,
                ...
                EarlyOvertimeMinutesThreshold = templateWithManager.EarlyOvertimeMinutesThreshold,
