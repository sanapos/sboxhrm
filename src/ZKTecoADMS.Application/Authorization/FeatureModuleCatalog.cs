...
public static class FeatureModuleCatalog
{
    ...
    [
        ...
        new("PosQrOrder", "QR order bàn", "In/sao QR gọi món tại bàn, bật/tắt QR order", "POS / Bán hàng", 69),
        new("PosCashierShift", "Ca thu ngân", "Mở/đóng ca, đối soát tiền mặt", "POS / Bán hàng", 70),
        new("PosPrinters", "Máy in POS", "Máy in hóa đơn/bếp/tem, Agent, tuyến in", "POS / Bán hàng", 71),
        new("HkdBooks", "Thuế hộ kinh doanh", "Sổ thuế HKD dưới 1 tỷ / 1–3 tỷ / trên 3 tỷ (TT 152/2025)", "Báo cáo", 72),
