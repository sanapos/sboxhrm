...
public static class FeatureModuleCatalog
{
    ...
    [
        ...
        new("PosPurchaseReturns", "Trả hàng nhập", "Trả hàng cho nhà cung cấp", "POS / Bán hàng", 57),
        new("PosStockCounts", "Kiểm kho POS", "Kiểm kê tồn kho", "POS / Bán hàng", 58),
        new("PosDamageIssues", "Xuất hủy POS", "Xuất hủy hàng hóa", "POS / Bán hàng", 59),
        new("PosInternalUseIssues", "Xuất dùng nội bộ", "Xuất dùng nội bộ hàng hóa", "POS / Bán hàng", 60),
        new("PosSalesReport", "Báo cáo doanh thu POS", "Thống kê doanh thu, đơn bán hàng", "POS / Bán hàng", 61),
