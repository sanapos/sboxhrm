...
public static class FeatureModuleCatalog
{
    ...
    [
        ...
        new("PosPrintTemplates", "Mẫu in POS", "Mẫu in hóa đơn, phiếu", "Thiết lập POS", 54),
        ...
        new("PosCustomerDisplay", "Màn hình phụ POS", "Customer display, media quảng cáo khi bán", "Thiết lập POS", 66),
        new("PosEInvoice", "Hóa đơn điện tử POS", "Viettel SInvoice, Easy Invoice, MISA — cấu hình, xuất, báo cáo", "Thiết lập POS", 67),
        new("PosKds", "Màn hình bếp (KDS)", "Phiếu chế biến, bump món, đọc món, in khi xong — tick riêng, không gộp vào Bán hàng", "POS / Bếp (KDS)", 68),
        ...
        new("PosPrinters", "Máy in thiết bị", "Máy in trên máy này: Bluetooth / LAN / USB, tem ly", "Thiết lập POS", 71),
