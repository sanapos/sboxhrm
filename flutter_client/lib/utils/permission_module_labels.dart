...
class PermissionModuleLabels {
  ...
  static const Map<String, String> byModule = {
    ...
    'PosSalesReport': 'Báo cáo POS (tổng hợp)',
    'PosReportRevenue': 'Doanh thu',
    'PosReportSoldGoods': 'Hàng hóa bán ra',
    'PosReportStock': 'Tồn kho',
    'PosReportPurchases': 'Báo cáo nhập hàng',
    'PosReportPayment': 'Phương thức thanh toán',
    'PosReportDebt': 'Công nợ',
    'PosReportExpiry': 'Hàng sắp hết hạn',
    'PosReportProfit': 'Lợi nhuận',
    ...
    'PosEInvoice': 'Hóa đơn điện tử POS',
