  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        backgroundColor: hubBody ? HrmPageChrome.scaffoldBackground(context) : const Color(0xFFF6F7F9),
        appBar: hideInnerBar || _editing || !HrmPageChrome.showInPageAppBar(context)
            ? null
            : AppBar(
        ...
        children: [
          Material(
            ...
            child: Padding(
              ...
              child: Row(children: [
                IconButton(onPressed: _exitEditor, icon: const Icon(Icons.arrow_back), tooltip: tr('Tất cả mẫu')),
                Expanded(
                  child: TextField(
                    controller: _nameCtrl,
