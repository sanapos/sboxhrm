              ...
              Row(
                children: [
                  ...
                  const Icon(Icons.schedule,
                      color: Color(0xFF0F2340), size: 26),
                  ...
                  child: Row(
                    children: [
                      _buildMiniStat(Icons.schedule, '${_shifts.length}',
                          'Tổng ca', const Color(0xFF0F2340)),
                      const SizedBox(width: 8),
                      _buildMiniStat(
                          Icons.check_circle,
        ...
        child: Row(
          children: [
            ...
            Icon(shift.isActive ? Icons.check_circle : Icons.pause_circle,
                size: 14,
                color: shift.isActive ? const Color(0xFF1E3A5F) : Colors.grey),
            const SizedBox(width: 4),
                              ...
                              : () async {
                                  ...
                                  if (shiftType == 'Qua đêm') {
                                    if (overnightCutoff == null) {
                                      appNotification.showWarning(
                                          title: 'Thiếu Giờ qua đêm',
                                          message:
                                              'Ca qua đêm bắt buộc phải thiết lập Giờ qua đêm');
                                      return;
                                    }
                                    ...
                                    final cutMin = overnightCutoff!.hour * 60 +
                                        overnightCutoff!.minute;
                                    ...
                                    if (cutMin == endMin) {
                                      appNotification.showWarning(
                                          title: 'Giờ qua đêm không hợp lệ',
                                          message:
                                              'Giờ qua đêm phải lớn hơn giờ kết thúc ca');
                                      return;
                                    }
                                  }
                                  ...
                                  final data = {
                                    ...
                                    if (shiftType == 'Qua đêm' &&
                                        overnightCutoff != null)
                                      'overnightCutoffTime':
                                          '${overnightCutoff!.hour.toString().padLeft(2, '0')}:${overnightCutoff!.minute.toString().padLeft(2, '0')}:00',
                                    if (shiftType != 'Qua đêm')
