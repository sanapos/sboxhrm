...
class _PosSellScreenState extends State<PosSellScreen> {
  ...
  Future<void> _kitchenSendCurrentTable() async {
    ...
    if (_autosavingDraft) {
      NotificationOverlayManager().showWarning(
        title: 'Đang lưu đơn',
        message: tr('Đợi lưu xong rồi báo bếp lại'),
      );
      return;
    }
  ...
  Future<void> _checkout() async {
    ...
    if (due > 0 && _tab.customer == null) {
      NotificationOverlayManager().showError(
        title: 'Thiếu khách hàng',
        message: tr('Chọn khách hàng để ghi nợ phần còn thiếu (${_moneyFmt.format(due)})'),
      );
      return;
    }
        ...
        if (canEod)
          PopupMenuItem(
            ...
            child: ListTile(
              ...
              title: Text(tr('Xem báo cáo cuối ngày')),
              contentPadding: EdgeInsets.zero,
            ),
          ),
        if (canReport)
          PopupMenuItem(
            ...
            child: ListTile(
              ...
              title: Text(tr('Báo cáo doanh thu / tồn kho')),
              contentPadding: EdgeInsets.zero,
            ),
          ),
        if (canReturn)
        ...
        if (canReturn)
          PopupMenuItem(
            ...
            child: ListTile(
              ...
              title: Text(tr('Chọn hóa đơn trả hàng')),
              contentPadding: EdgeInsets.zero,
            ),
          ),
        if (canReturn)
              ...
              child: _isTableOrderMode
                  ? Align(
                      ...
                      child: Wrap(
                        ...
                        spacing: 8,
                        children: [
                          Text(tr('${tr('Đơn ')}${_tab.serviceResourceName ?? 'bàn'}'
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Expanded(
              child: Text(tr('Sơ đồ bàn — chạm vào bàn để bắt đầu'),
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.w600,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              tr(tableLabel.isEmpty ? 'Giỏ hàng' : tableLabel),
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              style: const TextStyle(
                fontWeight: FontWeight.w700,
