...
class PosServiceResourceDto {
  ...
  /// Máy này vừa TT / trả bàn — tô trống ngay, không chờ GET sơ đồ.
  PosServiceResourceDto asLocallyFreed() => PosServiceResourceDto(
        id: id,
        areaId: areaId,
        areaName: areaName,
        code: code,
        ...
        isActive: isActive,
        occupancyStatus: needsCleaning ? 'Dirty' : 'Free',
        openSessionId: null,
        openOrderId: null,
