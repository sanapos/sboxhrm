...
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\fix_pos_variant_deleted_sku.sql" -RemotePath "${User}@${Server}:/root/fix_pos_variant_deleted_sku.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_stock_variant_id.sql" -RemotePath "${User}@${Server}:/root/add_pos_stock_variant_id.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_stock_p1.sql" -RemotePath "${User}@${Server}:/root/add_pos_stock_p1.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_purchase_kiot.sql" -RemotePath "${User}@${Server}:/root/add_pos_purchase_kiot.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_purchase_vat_discount.sql" -RemotePath "${User}@${Server}:/root/add_pos_purchase_vat_discount.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_purchase_vat_included.sql" -RemotePath "${User}@${Server}:/root/add_pos_purchase_vat_included.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_stock_count_kiot.sql" -RemotePath "${User}@${Server}:/root/add_pos_stock_count_kiot.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_stock_issue_kiot.sql" -RemotePath "${User}@${Server}:/root/add_pos_stock_issue_kiot.sql"
Invoke-PuttyScp -Pscp $pscp -Password $Password -LocalPath "$RepoRoot\scripts\add_pos_sale_order_kiot.sql" -RemotePath "${User}@${Server}:/root/add_pos_sale_order_kiot.sql"
